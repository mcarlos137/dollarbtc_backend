 ...
 * @author carlosmolina
 */
public class CashActivatePlace extends AbstractOperation<String> {

    private final String placeId;

    public CashActivatePlace(String placeId) {
        super(String.class);
    ...
    public void execute() {
        ...
        try {
            ...
            CashCreatePlaceStatus mcRetailCreateStatus = CashCreatePlaceStatus.valueOf(cashPlaceConfig.get("mcRetailCreateStatus").textValue());
            if (!mcRetailCreateStatus.equals(CashCreatePlaceStatus.ACTIVATED)) {
                super.response = "CASH PLACE IS NOT ALREADY ACTIVATED BY SYSTEM";
                return;
            }
            ...
            Logger.getLogger(CashActivatePlace.class.getName()).log(Level.SEVERE, null, ex);
        }
        super.response = "FAIL";
    }
