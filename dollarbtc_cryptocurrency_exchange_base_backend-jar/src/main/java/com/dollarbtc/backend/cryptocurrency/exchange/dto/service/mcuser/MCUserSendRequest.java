 ...
 * @author CarlosDaniel
 */
public class MCUserSendRequest {
    
    private String baseUserName, targetUserName, currency, description, baseName, targetName, clientId;
    private Double amount;
    private boolean international;
    private String receiveAuthorizationId;
