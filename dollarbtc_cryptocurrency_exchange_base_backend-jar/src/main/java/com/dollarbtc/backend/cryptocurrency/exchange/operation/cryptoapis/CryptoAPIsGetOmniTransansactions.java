 ...
 * @author carlosmolina
 */
public class CryptoAPIsGetOmniTransansactions extends AbstractRestClient<JsonNode> {

    private static Client client;
    private final Set<String> addresses;
    private final String type, network;
    private final Integer blockchainHeight, propertyId;

    public CryptoAPIsGetOmniTransansactions(Set<String> addresses, String type, String network, Integer blockchainHeight, Integer propertyId) {
    ...
    public JsonNode getResponse() {
        ...
        for (String address : addresses) {
            String params = "/" + address + "/transactions";
            JsonNode addressResponse = super.getJsonNode("https://rest.cryptoapis.io/v2/blockchain-data/bitcoin" + "/" + network, "/omni/addresses", params, RequestRestType.SYNC, null, null, 30);
            ...
            while (addressTxsResponseIterator.hasNext()) {
                ...
                Integer propertyIdd = addressTxsResponseIt.get("propertyId").intValue();
                if (!propertyIdd.equals(propertyId)) {
                    continue;
                }
