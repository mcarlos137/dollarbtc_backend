 ...
 */
public class LiveStreamingsFolderLocator {
    
    public static File getFolder() {
        return FileUtil.createFolderIfNoExist(new File(OPERATOR_PATH, "LiveStreamings"));
    }
    ...
    public static File getCommentsFile(String id, String publicationId, int page) {
        return new File(getCommentsFolder(), id + "__" + publicationId + "__" + page + ".json");
    }
