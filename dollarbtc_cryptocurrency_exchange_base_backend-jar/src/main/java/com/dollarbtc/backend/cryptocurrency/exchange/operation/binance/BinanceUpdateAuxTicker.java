 ...
 * @author carlosmolina
 */
public class BinanceUpdateAuxTicker extends AbstractOperation<Void> {
    
    private final String[] baseCurrenciesAndTargetCurrencies;

    public BinanceUpdateAuxTicker(String[] baseCurrenciesAndTargetCurrencies) {
        super(Void.class);
    ...
    private synchronized void method(String[] baseCurrenciesAndTargetCurrencies) {
        ...
        for (String baseCurrencyAndTargetCurrency : baseCurrenciesAndTargetCurrencies) {
            ...
            File baseTickersFolder = BinanceFolderLocator.getTickersSymbolFolder(symbolAsset + baseCurrency);
            ...
            for (File tickerFile : baseTickersFolder.listFiles()) {
                ...
                try {
                    ...
                    Logger.getLogger(BinanceUpdateAuxTicker.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            if (baseTicker == null) {
                continue;
            ...
            File targetTickersFolder = BinanceFolderLocator.getTickersSymbolFolder(symbolAsset + targetCurrency);
