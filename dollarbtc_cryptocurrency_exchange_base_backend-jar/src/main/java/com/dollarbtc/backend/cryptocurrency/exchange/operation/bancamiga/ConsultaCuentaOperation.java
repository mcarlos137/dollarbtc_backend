 ...
 * @author CarlosDaniel
 */
public class ConsultaCuentaOperation extends AbstractBancamigaRestClient<JsonNode> {

    private static final String ENDPOINT = "/api/v1/consulta/cuenta";
    
    public ConsultaCuentaOperation(String cuenta) {
