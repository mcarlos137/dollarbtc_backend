 ...
 * @author carlosmolina
 */
public class MCUserGetBalanceMovements extends AbstractOperation<JsonNode> {
    
    private final String userName, initTimestamp, endTimestamp;
    private final BalanceOperationType balanceOperationType;

    public MCUserGetBalanceMovements(String userName, String initTimestamp, String endTimestamp, BalanceOperationType balanceOperationType) {
    ...
    public void execute() {
        ...
        for (File userBalanceMovementFile : userBalanceFolder.listFiles()) {
            ...
            try {
                ...
                Logger.getLogger(MCUserGetBalanceMovements.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
