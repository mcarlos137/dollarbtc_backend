 ...
 */
@XmlRootElement
public class BuyBalanceChangeOperationStatusRequest implements Serializable, Cloneable {
    ...
    public BuyBalanceChangeOperationStatusRequest() {
    }

    public BuyBalanceChangeOperationStatusRequest(String id, OTCOperationStatus otcOperationStatus, boolean userChange) {
        this.id = id;
