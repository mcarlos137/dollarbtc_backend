 ...
 */
public class SubscriptionsFolderLocator {

    public static File getFolder() {
        return FileUtil.createFolderIfNoExist(new File(OPERATOR_PATH, "Subscriptions"));
    }
    ...
    public static File getPremiumOverviewFile() {
        return new File(getFolder() , "premiumOverview.json");
    }
