 ...
 */
@XmlRootElement
public class BankerGetOperationsNewRequest implements Serializable, Cloneable {
    ...
    public BankerGetOperationsNewRequest() {
    }

    public BankerGetOperationsNewRequest(String userName, String initTimestamp, String finalTimestamp, String[] operationUserNames, String[] currencies, OTCOperationType[] otcOperationTypes, OTCOperationStatus[] otcOperationStatuses, Map<String, String[]> specialIndexes) {
