 ...
 * @author carlosmolina
 */
public class UserGetVerificationFieldsNew extends AbstractOperation<JsonNode> {

    private final UserVerificationType userVerificationType;

    public UserGetVerificationFieldsNew(UserVerificationType userVerificationType) {
    ...
    protected void execute() {
        ...
        try {
            ...
            Logger.getLogger(UserGetVerificationFieldsNew.class.getName()).log(Level.SEVERE, null, ex);
        }
