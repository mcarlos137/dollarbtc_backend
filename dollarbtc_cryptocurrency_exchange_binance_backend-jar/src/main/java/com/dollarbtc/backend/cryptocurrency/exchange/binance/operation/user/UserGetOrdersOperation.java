 ...
 * @author CarlosDaniel
 */
public class UserGetOrdersOperation extends WebSocketBasicUser {
    
    private static final String OPERATION = "Orders";
        
    public UserGetOrdersOperation(String modelName, int id) {
