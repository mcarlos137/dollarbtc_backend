...
import com.dollarbtc.backend.cryptocurrency.exchange.binance.dto.Ticker;
...
public class GetTickerOperation extends AbstractRestClient<Ticker> {
    ...
    private static final String URL = "https://api.binance.com/api/v3/ticker/bookTicker?symbol=";
    ...
    public Ticker getResponse() {
        return super.get(URL + ExchangeUtil.getSymbol("Binance", symbol), RequestRestType.SYNC, null, null, 30);
    }
