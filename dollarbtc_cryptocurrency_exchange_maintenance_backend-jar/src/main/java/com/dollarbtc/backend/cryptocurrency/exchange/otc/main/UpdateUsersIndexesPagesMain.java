 ...
 * @author CarlosDaniel
 */
public class UpdateUsersIndexesPagesMain {
...
//                continue;
//            }
            Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "INIT USERNAME {0}", userFolder.getName());
            if (updateUserIndexes(mapper, userFolder.getName(), usersIndexesNames)) {
                i++;
                Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "FINISH USERNAME {0}", userFolder.getName());
            } else {
                Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "SKIP USERNAME {0}", userFolder.getName());
            }
        }
    }
    ...
    private static boolean updateUserIndexes(ObjectMapper mapper, String userName, List<String> usersIndexesNames) {
        ...
        if (userIndexesFile.isFile()) {
            try {
                ...
                Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        if (userIndexes.has("update") && !userIndexes.get("update").booleanValue()) {
            return false;
        }
        Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "update");
        ...
        while (userIndexNamesIterator.hasNext()) {
            ...
            Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "index name {0}", userIndexNameIt);
            Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "index value {0}", userIndexes.get(userIndexNameIt).textValue().replaceAll("'", "").trim().toUpperCase());
            Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "DELETE");
            ...
            Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "file deleted");
            userIndexNamesIterator.remove();
            Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "field deleted");
        }
        String timestamp = DateUtil.getCurrentDate();
        for (String userIndexName : usersIndexesNames) {
            Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "index name {0}", userIndexName);
            if (userConfig.has(userIndexName) && userConfig.get(userIndexName) != null && userConfig.get(userIndexName).textValue() != null && !userConfig.get(userIndexName).textValue().equals("")) {
                Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "index value {0}", userConfig.get(userIndexName).textValue().replaceAll("'", "").trim().toUpperCase());
                Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "CREATE");
                ((ObjectNode) userIndexes).put(userIndexName, userConfig.get(userIndexName).textValue().replaceAll("'", "").trim().toUpperCase());
                Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "field created");
                ...
                Logger.getLogger(UpdateUsersIndexesPagesMain.class.getName()).log(Level.INFO, "file created");
            }
        }
