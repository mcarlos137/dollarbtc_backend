 ...
 * @author CarlosDaniel
 */
public class TradesTo1MinuteFileMain {
    ...
    public static void main(String[] args) {
        ...
        for (String exchangeIdSymbol : exchangeIdSymbols) {
            ...
            for (String timestamp : timestamps) {
                ...
                List<String> startMinuteTimestamps = new ArrayList<>();
                try (final DirectoryStream<Path> stream = Files.newDirectoryStream(Paths.get(folder.getPath()));) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        String startMinuteTimestamp = DateUtil.getMinuteStartDate(tradeData.get("timestamp").textValue());
                        if (!startMinuteTimestamps.contains(startMinuteTimestamp)) {
                            startMinuteTimestamps.add(startMinuteTimestamp);
