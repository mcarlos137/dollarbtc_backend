 ...
 * @author CarlosDaniel
 */
public class GetDashboardReleasedOperation extends AbstractRestClient<JsonNode> {

    private static Client client;
    private static final String ENDPOINT = "/api/dashboard/released/";
    private final String key, secret;

    public GetDashboardReleasedOperation(String key, String secret) {
