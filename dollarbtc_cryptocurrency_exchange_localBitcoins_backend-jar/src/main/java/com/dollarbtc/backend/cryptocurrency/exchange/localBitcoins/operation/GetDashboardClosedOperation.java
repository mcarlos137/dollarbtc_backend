 ...
 * @author CarlosDaniel
 */
public class GetDashboardClosedOperation extends AbstractRestClient<JsonNode> {

    private static Client client;
    private static final String ENDPOINT = "/api/dashboard/closed/";
    private final String key, secret;

    public GetDashboardClosedOperation(String key, String secret) {
