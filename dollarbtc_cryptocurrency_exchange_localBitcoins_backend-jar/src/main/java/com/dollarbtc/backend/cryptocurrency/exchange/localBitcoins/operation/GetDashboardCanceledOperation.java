 ...
 * @author CarlosDaniel
 */
public class GetDashboardCanceledOperation extends AbstractRestClient<JsonNode> {

    private static Client client;
    private static final String ENDPOINT = "/api/dashboard/canceled/";
    private final String key, secret;

    public GetDashboardCanceledOperation(String key, String secret) {
