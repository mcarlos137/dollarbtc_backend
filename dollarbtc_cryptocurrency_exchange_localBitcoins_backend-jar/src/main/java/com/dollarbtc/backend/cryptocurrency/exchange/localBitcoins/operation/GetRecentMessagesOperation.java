 ...
 * @author CarlosDaniel
 */
public class GetRecentMessagesOperation extends AbstractRestClient<JsonNode> {

    private static Client client;
    private static final String ENDPOINT = "/api/recent_messages/";
    private final String key, secret;

    public GetRecentMessagesOperation(String key, String secret) {
