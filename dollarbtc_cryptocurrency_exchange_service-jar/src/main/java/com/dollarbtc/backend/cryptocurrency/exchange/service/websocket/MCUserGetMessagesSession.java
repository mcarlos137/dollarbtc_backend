...
import com.dollarbtc.backend.cryptocurrency.exchange.service.websocket.message.MCUserGetMessagesMessage;
 ...
 * @author CarlosDaniel
 */
public class MCUserGetMessagesSession {
    ...
    public static void addSession(Session session, JsonNode jsonNode) {
        ...
        scheduledExecutorService.scheduleAtFixedRate(new MCUserGetMessagesMessage(session, jsonNode), 0, 3, TimeUnit.SECONDS);
