...
import com.dollarbtc.backend.cryptocurrency.exchange.service.websocket.message.MoneyMarketGetPricesMessage;
 ...
 * @author CarlosDaniel
 */
public class MoneyMarketGetPricesSession {
    ...
    public static void addSession(Session session, JsonNode jsonNode) {
        ...
        scheduledExecutorService.scheduleAtFixedRate(new MoneyMarketGetPricesMessage(session, jsonNode), 0, 5, TimeUnit.SECONDS);
