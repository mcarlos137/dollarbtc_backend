 ...
 * @author CarlosDaniel
 */
public class ExchangeGetCurrencyServiceWSClient extends WebSocketClient {

    private final static String URI = "ws://localhost:8081/exchange";

    public ExchangeGetCurrencyServiceWSClient() {
        super(URI);
        prepareRequest();
    }
    ...
    protected void prepareRequest() {
        ...
        ((ObjectNode) jsonNode).put("method", "getCurrency");
        JsonNode params = mapper.createObjectNode();
        ((ObjectNode) params).put("currency", "BTC");
    ...
    private void keepAlive() {
        while (true) {
            try {
                ...
                Logger.getLogger(ExchangeGetCurrencyServiceWSClient.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
