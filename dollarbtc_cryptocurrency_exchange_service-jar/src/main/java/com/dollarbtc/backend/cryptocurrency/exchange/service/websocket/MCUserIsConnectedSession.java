...
import com.dollarbtc.backend.cryptocurrency.exchange.service.websocket.message.MCUserIsConnectedMessage;
 ...
 * @author CarlosDaniel
 */
public class MCUserIsConnectedSession {
    ...
    public static void addSession(Session session, JsonNode jsonNode) {
        ...
        scheduledExecutorService.scheduleAtFixedRate(new MCUserIsConnectedMessage(session, jsonNode), 0, 3, TimeUnit.SECONDS);
