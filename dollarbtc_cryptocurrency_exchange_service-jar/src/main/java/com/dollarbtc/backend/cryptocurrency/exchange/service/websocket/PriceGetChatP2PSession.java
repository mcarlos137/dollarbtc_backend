...
import com.dollarbtc.backend.cryptocurrency.exchange.service.websocket.message.PriceGetChatP2PMessage;
 ...
 * @author CarlosDaniel
 */
public class PriceGetChatP2PSession {
    ...
    public static void addSession(Session session, JsonNode jsonNode) {
        ...
        scheduledExecutorService.scheduleAtFixedRate(new PriceGetChatP2PMessage(session, jsonNode), 0, 1, TimeUnit.SECONDS);
