 ...
 * @author CarlosDaniel
 */
public class ExchangeSubscribeOrderbookServiceWSClient extends WebSocketClient {

    private final static String URI = "ws://localhost:8081/exchange";

    public ExchangeSubscribeOrderbookServiceWSClient() {
        super(URI);
        prepareRequest();
    }
    ...
    protected void prepareRequest() {
        ...
        ((ObjectNode) jsonNode).put("method", "subscribeOrderbook");
    ...
    private void keepAlive() {
        while (true) {
            try {
                ...
                Logger.getLogger(ExchangeSubscribeOrderbookServiceWSClient.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
