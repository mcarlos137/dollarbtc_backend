 ...
 * @author CarlosDaniel
 */
public class ExchangeSubscribeTickerServiceWSClient extends WebSocketClient {

    private final static String URI = "ws://localhost:8081/exchange";

    public ExchangeSubscribeTickerServiceWSClient() {
        super(URI);
        prepareRequest();
    }
    ...
    protected void prepareRequest() {
        ...
        ((ObjectNode) jsonNode).put("method", "subscribeTicker");
    ...
    private void keepAlive() {
        while (true) {
            try {
                ...
                Logger.getLogger(ExchangeSubscribeTickerServiceWSClient.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
