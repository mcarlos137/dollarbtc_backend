...
import com.dollarbtc.backend.cryptocurrency.exchange.service.websocket.message.MoneyMarketGetOrderBookMessage;
 ...
 * @author CarlosDaniel
 */
public class MoneyMarketGetOrderBookSession {
    ...
    public static void addSession(Session session, JsonNode jsonNode) {
        ...
        scheduledExecutorService.scheduleAtFixedRate(new MoneyMarketGetOrderBookMessage(session, jsonNode), 0, 10, TimeUnit.SECONDS);
