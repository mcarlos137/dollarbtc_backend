...
import com.dollarbtc.backend.cryptocurrency.exchange.service.websocket.message.MCUserIsWritingMessage;
 ...
 * @author CarlosDaniel
 */
public class MCUserIsWritingSession {
    ...
    public static void addSession(Session session, JsonNode jsonNode) {
        ...
        scheduledExecutorService.scheduleAtFixedRate(new MCUserIsWritingMessage(session, jsonNode), 0, 3, TimeUnit.SECONDS);
