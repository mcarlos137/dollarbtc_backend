 ...
 * @author CarlosDaniel
 */
public class ExchangeSubscribeCandlesServiceWSClient extends WebSocketClient {

    private final static String URI = "ws://localhost:8081/exchange";

    public ExchangeSubscribeCandlesServiceWSClient() {
        super(URI);
        prepareRequest();
    }
    ...
    protected void prepareRequest() {
        ...
        ((ObjectNode) jsonNode).put("method", "subscribeCandles");
        JsonNode params = mapper.createObjectNode();
        ((ObjectNode) params).put("symbol", "BTCUSDT");
        ((ObjectNode) params).put("period", "M30");
    ...
    private void keepAlive() {
        while (true) {
            try {
                ...
                Logger.getLogger(ExchangeSubscribeCandlesServiceWSClient.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
