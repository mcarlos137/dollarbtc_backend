...
public abstract class HMACFilter implements Filter {
        ...
        if (request instanceof HttpServletRequest && response instanceof HttpServletResponse) {
            ...
            if (authorization != null) {
                ...
                try {
                    ...
                    java.util.logging.Logger.getLogger(HMACFilter.class.getName()).log(Level.INFO, "realm: " + realm);
                    if(realm.contains("____")){
                        realm = realm.replace("____", "@");                        
                    } 
                    String deviceId = authHeader.getDeviceId();
                    secretKey = getSecretKey(accessKey, realm, deviceId);
     ...
     */
    protected abstract String getSecretKey(String accessKey, String realm, String deviceId) throws SecretKeyException;
