 ...
 * @author CarlosDaniel
 */
public class ExchangeSubscribeTradesServiceWSClient extends WebSocketClient {

    private final static String URI = "ws://localhost:8081/exchange";

    public ExchangeSubscribeTradesServiceWSClient() {
        super(URI);
        prepareRequest();
    }
    ...
    protected void prepareRequest() {
        ...
        ((ObjectNode) jsonNode).put("method", "subscribeTrades");
    ...
    private void keepAlive() {
        while (true) {
            try {
                ...
                Logger.getLogger(ExchangeSubscribeTradesServiceWSClient.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
